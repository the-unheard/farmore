...
use App\Http\Controllers\ManageCropDataController;
...
Route::resource('/manage-crop-data', ManageCropDataController::class)->only(['index', 'show', 'edit', 'update'])->middleware('role:admin');
