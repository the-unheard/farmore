<x-layout-auth>
    <x-slot:title>GreenMap - Login</x-slot:title>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="bg-gray-50 p-12 rounded-lg shadow-sm mx-auto sm:w-full sm:max-w-sm border-gray-200 border-2">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p class="text-gray-600 text-sm text-center m-4">Don't have an account?
                    <a href="/auth/register" class="font-semibold text-grad-blue">Register</a>
                </p>
            </div>
        </div>
    </div>
